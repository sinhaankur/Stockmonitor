...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  forecast: { name: 'AI Forecasts', enabled: false, priority: 1 },
  ...
  'disaster-correlation': { name: 'Disaster Cascade', enabled: false, priority: 2 },
  ...
  commodities: { name: 'Metals & Materials', enabled: false, priority: 1 },
  'energy-complex': { name: 'Energy Complex', enabled: false, priority: 1 },
  ...
  'chat-analyst': { name: 'WM Analyst', enabled: false, priority: 1 },
  ...
  'hormuz-tracker': { name: 'Hormuz Trade Tracker', enabled: false, priority: 2 },
  ...
  'wsb-ticker-scanner': { name: 'WSB Ticker Scanner', enabled: false, priority: 75 },
  ...
  'cross-source-signals': { name: 'Cross-Source Signals', enabled: false, priority: 2 },
...
const TECH_PANELS: Record<string, PanelConfig> = {
  ...
  'stock-monitor': { name: 'Stock Monitor', enabled: true, priority: 2 },
